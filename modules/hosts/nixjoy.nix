    ...
    }:
    {
      ...
      admasnd.dotfiles = {
        gaming = {
          ...
          remotePlay.enable = lib.mkDefault true;
          steam.gameModeUser = "joy";
        };
        vm = {
          enable = lib.mkDefault true;
          cores = lib.mkDefault 2;
          vmPort = lib.mkDefault 5930;
          memorySize = lib.mkDefault 8192;
        };
      };

      specialisation.vm.configuration = {
        fileSystems."/boot".device = lib.mkForce "/dev/disk/by-uuid/5E43-03DB";
        fileSystems."/".device = lib.mkForce "/dev/disk/by-uuid/5c5fb084-7bb0-478a-93d9-22d219f5af42";
