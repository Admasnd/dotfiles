...
(cons* 
 ...
 (channel
   ...
   (introduction
    (make-channel-introduction
     "fa462377e26eb76e8c0c220a7a539c31e52d1a50"
     (openpgp-fingerprint
      "C03E E946 9F71 850B 825E C047 ADC0 CB41 850B 7A52"))))
	%default-channels)
#+end_src
...
(use-service-modules desktop xorg syncthing linux)
(use-package-modules certs gnome vim bash xorg)
